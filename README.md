...
Джойстик-сфера:
![Sphere joystick](sphere_manipulator.jpg  "Джойстик сфера")
...
### Управление со специализированного манипулятора (сфера на параллельной платформе)
...
## Ссылки и кредиты
Работа над этим манипулятором является продолжением ранее разработанного манипулятора. Первая версия манипулятора была разработана в рамка гранта РФФИ. Видео презентация внешнего вида и возможностей манипулятора доступны по ссылке ниже
